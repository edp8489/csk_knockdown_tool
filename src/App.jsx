...
import { KcskPlot } from "./components/Graphs";
    ...
    <ThemeProvider theme={theme}>
      ...
      <Box className="App" sx={{ width: "75%", marginLeft: "12.5%", marginRight: "12.5%" }}>
            ...
            <Accordion expanded={true} TransitionProps={{ unmountOnExit: true }}>
              ...
              <AccordionDetails>
                <Box sx={{ typography: "p", textAlign: "left" }}>
                  ...
                  curve appropriately.
                  <br /> <br />
                  <b>Sheet Fbru:</b> Ultimate bearing strength of user sheet material<br />
                ...
                <Box sx={{ typography: "p" }}>
                  ...
                  3. (TODO) Plot of bearing strength knockdown vs countersink depth ratio with bearing-shear envelope scaled by user-supplied Fbru value
                </Box>
              </AccordionDetails>
            </Accordion>
        ...
        <Paper elevation={3} sx={{ padding: "10px", textAlign: "center" }}>
          ...
          {rawDataPlot}
          {kcskPlot}
          <KcskPlot CJS={ChartJS} userScaled={true} />
        </Paper>
        <Footer />
      </Box>
    </ThemeProvider>
